...
$packages["github.com/gopherjs/webgl"] = (function() {
	...
	NewContext = function(canvas, ca) {
		var $ptr, _key, _map, attrs, ca, canvas, ctx, gl;
...
$packages["main"] = (function() {
	var $pkg = {}, $init, js, webgl, ptrType, funcType, document, canvas, gl, initCanvas, initWebGl, onWindowResize, onBodyLoad, main;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	...
	onWindowResize = function() {
		...
		width = (height * 0.6666666666666666 >> 0);
		canvas.width = width;
	...
	main = function() {
		...
		$global.addEventListener($externalize("resize", $String), $externalize(onWindowResize, funcType));
	};
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
